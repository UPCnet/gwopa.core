...
class setup(grok.View):
    ...
    def createDemoContent(self):
        ...
        working_areas = [
            ...
            'Energy efficiency',
            'Resilience (climate change adaptation, natural disaster risk management, others)',
            'Catchment management; IWRM',
            'Water demand management',
            'Asset management',
            'Billing & collection efficiency',
            'Commercial losses management',
            'Physical losses management',
...
class setupEs(grok.View):
    ...
    def createDemoContent(self):
        ...
        working_areas = [
            ...
            'Áreas de población con bajos ingresos',
            'Calidad del agua y seguridad',
            'Saneamiento e higiene',
            'Extensión de la red de suministro',
            'Inclusión social y genero',
            'Aguas residuales',
            'Eficiencia energética',
            'Resiliencia (adaptación al cambio climático, gestión de riesgo de desastres naturales)',
            'Gestión de cuenca hidrográfica',
            'Gestión de la demanda',
            'Gestión de activos',
            'Gestión de facturación y recolección',
            'Gestión de las perdidas comerciales de agua no contabilizada',
            'Gestión de perdidas físicas de agua no contabilizada',
            'Información y tecnología',
            'Gestión corporativa e institucional',
